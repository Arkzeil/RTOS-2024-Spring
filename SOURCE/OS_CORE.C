...
void  OSIntExit (void)
{
    ...
    if (OSRunning == TRUE) {
        ...
        PC_DispStr(1, 0, "preempt", DISP_FGND_BLACK + DISP_BGND_LIGHT_GRAY);
    }
}
/*$PAGE*/
/*
...
void  OS_Sched (void)
{
    ...
    OS_EXIT_CRITICAL();
    /*Add codes for Lab1*/
    sprintf(numStr, "%d", OSTime/1000);
    PC_DispStr(0, 0, numStr, DISP_FGND_BLACK + DISP_BGND_LIGHT_GRAY);
    PC_DispStr(0, 3, "complete", DISP_FGND_BLACK + DISP_BGND_LIGHT_GRAY);
    sprintf(numStr, "%d", OSTCBCur->OSTCBPrio);
    PC_DispStr(0, 5, numStr, DISP_FGND_BLACK + DISP_BGND_LIGHT_GRAY);
}
/*$PAGE*/
/*
*********************************************************************************************************
